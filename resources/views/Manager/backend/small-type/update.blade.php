...
<div id="page-wrapper">
    ...
    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sửa loại sản phẩm</h1>
                </div>
                <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="panel panel-info">
					...
					<form action="{!!url('/dashboard/big_type/update/'.$small_types->id.'') !!}" method="POST"  enctype="multipart/form-data">
						                    ...
						                    <div class="panel-body">
						                        <div class="col-lg-12">
							                                ...
							                                <div class="form-group">
							                                    ...
							                                    <input required class="form-control" name="name_type" value="{!! $small_types->name_type !!}" placeholder="Tên sản phẩm"  />
							                                    
							                                </div>

							                                <div class="form-group">
							                                    <label>Mô tả</label>
							                                    <input  class="form-control" name="description" value="{!! $small_types->description !!}"  />
		                                                        ...
		                                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
		                                                            <div class="form-group">
		                                                                ...
		                                                                <div class="form-line" style=" padding-bottom:20px;">
		                                                                   ...
		                                                                   <a>
		                                                                   	<input type="text" name="currentImage" id="new_image" class="form-control" required="" value="{!! $small_types->image_type!!}" disabled="">

		                                                                   	 <img src="images/{!! $small_types->image_type!!}" class="img-responsive img-rounded" alt="Image" style="width: 70px; height: 40px;">
