						                    ...
						                    @if(Auth::check())
							                    ...
							                    @if(Auth::user()->group == 2)
							                        <div class="col-lg-12">							                             
								                                <div class="form-group">
								                                    <label>Tên tài khoản</label>
								                                    <input required class="form-control" name="full_name" value="{{$users->full_name}}" placeholder="Tên sản phẩm"  disabled="" 
								           	                          />
								                                ...
								                                <div class="form-group">
								                                    <label>Email</label>
								                                    <input  class="form-control" name="email" 
								                                    value="{{$users->email}}"  required=""  pattern="[a-z0-9._%+-]+@[gmail]+\.[com]{2,63}$" disabled="" />
								                                    
								                                </div>

								                                 <div class="form-group">
								                                    <label>Phone</label>
								                                    <input required class="form-control" name="phone" value="{{$users->phone}}" placeholder="phone_number"  required=""  pattern="[0-9]{10,11}" maxlength='10' title=" nhâp số điện thoại 10 hoặc 11 chữ số" disabled="" />
								                                    <div>
								                                 ...
								                                 <div class="form-group">
								                                    <label>Address</label>
								                                    <input required class="form-control" name="address" value="{{$users->address}}" placeholder="Address"  required="" disabled="" />
								                                    <div>
								                                      
								                                    </div>
								                                </div>
							                                <div   class="row clearfix"><button type="submit" class="btn btn-primary" id= "modal3" value="{{$users->id}}" >Nâng cấp lên tài khoản admin</button></div>
